...
const roleDetails: Record<string, { situations: string[]; products: string[] }> = {
  "bao-tri": {
    situations: [
      ...
      "Ưu tiên NTN, đối chiếu thêm Koyo hoặc NOK khi cần phương án thay thế",
    ],
  ...
  "chu-xuong": {
    situations: [
      ...
      "Tự sửa chữa nhưng không rõ mã chính xác của vòng bi, gối đỡ hoặc dây truyền động",
      ...
      <div className="page-shell max-w-3xl space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl border border-blue-200 bg-blue-50/70 p-6">
            <h3 className="text-sm font-semibold text-blue-900">Hỗ trợ từ bên mình</h3>
