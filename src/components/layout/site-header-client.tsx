...
export function SiteHeaderClient({ coreBrands }: SiteHeaderClientProps) {
            ...
            <SheetContent side="right" className="w-[280px]">
              <div className="mt-8 space-y-6">
                <div className="space-y-2">
                  <CoreBrandMarks compact brands={coreBrands} />
