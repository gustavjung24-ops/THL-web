...
export function AssistantMessage({ role, text }: AssistantMessageProps) {
  ...
  return (
    <div className={cn("flex w-full", isAssistant ? "justify-start pr-10" : "justify-end pl-10")}>
      <div
        className={cn(
          "max-w-full rounded-2xl px-3.5 py-2.5 text-[13px] leading-6 shadow-sm sm:text-sm",
          isAssistant
